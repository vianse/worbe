module ExperiencesHelper
	...
	def botonera_experiences
		html="
			<div class='right'>
				<input class='btn btn-info' name='commit' type='submit' value='Guardar'>
				<a href='/experiences' class = 'btn btn-warning'>Regresar</a>
			</div>
			 "
		html.html_safe
	end
		 def botonera_index_experiences
	 	html="
	 			<div class='right'>
		 			<a href='/experiences/new' class = 'btn btn-default'>Agregar +</a>
