...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { code_state: @state.code_state, country_id: @state.country_id, name: @state.name }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { code_state: @state.code_state, country_id: @state.country_id, name: @state.name }
    assert_redirected_to state_path(assigns(:state))
  end
